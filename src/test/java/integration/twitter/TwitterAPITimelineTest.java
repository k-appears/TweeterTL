...
import twitter.TimelineAPI_NotToUse;
...
@Deprecated
public class TwitterAPITimelineTest {

    @Test
    public void searchNumberTweetsEmpty() throws InvalidQueryException {
        TimelineAPI_NotToUse twitterAPIBroken = new TimelineAPI_NotToUse();
    ...
    @Deprecated
    @Test
    public void searchNumberTweets() throws InvalidQueryException {
        TimelineAPI_NotToUse twitterAPIBroken = new TimelineAPI_NotToUse();
